...
def main():
    ...
    parser.add_argument("--history_len", default=2, type=int, help="keep len of history quesiton-answers")
    parser.add_argument('--qa_tag', action='store_true', help='add qa tag or not')
    parser.add_argument(
        "--n_best_size",
        default=20,
        type=int,
